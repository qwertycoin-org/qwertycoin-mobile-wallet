/*! kjua v0.1.1 - https://larsjung.de/kjua/ */ ! function (r, t) {
    ...
    return function (r) {
                    ...
                    var t = function (t, e) {
                        var o = 236,
                            ...
                            m = function (r, t) {
                                for (var e = -1; 7 >= e; e += 1)
                                    if (!(-1 >= r + e || r + e >= h))
                                        for (var n = -1; 7 >= n; n += 1) - 1 >= t + n || t + n >= h || (e >= 0 && 6 >= e && (0 == n || 6 == n) || n >= 0 && 6 >= n && (0 == e || 6 == e) || e >= 2 && 4 >= e && n >= 2 && 4 >= n ? g[r + e][t + n] = !0 : g[r + e][t + n] = !1)
                            },
                            A = function () {
                            ...
                            E = function () {
                                for (var r = i.getPatternPosition(l), t = 0; t < r.length; t += 1)
                                    for (var e = 0; e < r.length; e += 1) {
                                        ...
                                        if (null == g[n][o])
                                            for (var a = -2; 2 >= a; a += 1)
                                                for (var u = -2; 2 >= u; u += 1) - 2 == a || 2 == a || -2 == u || 2 == u || 0 == a && 0 == u ? g[n + a][o + u] = !0 : g[n + a][o + u] = !1
                                    }
                            },
                            T = function (r) {
                            ...
                            b = function (t, e) {
                                ...
                                for (var p = new Array(y), m = 0, g = 0; o > g; g += 1)
                                    for (var c = 0; c < e.length; c += 1) g < u[c].length && (p[m] = u[c][g], m += 1);
                                for (var g = 0; a > g; g += 1)
                                    for (var c = 0; c < e.length; c += 1) g < f[c].length && (p[m] = f[c][g], m += 1);
                                return p
                            },
                            x = function (r, t, e) {
        ...
        var n = e(5),
            ...
            u = function (r, t, e) {
                if (r) {
                    ...
                    for (var c = 0; i > c; c += 1)
                        for (var l = 0; i > l; l += 1) o(r, t, e, u, c, l);
        ...
        var e = function (r, t) {
                var e = t.size,
                    n = "bold " + .01 * t.mSize * e + "px " + t.fontname;
                r.strokeStyle = t.back, r.lineWidth = .01 * t.mSize * e * .1, r.fillStyle = t.fontcolor, r.font = n;
                var o = r.measureText(t.label).width,
                    i = .01 * t.mSize,
                    a = o / e,
                    u = (1 - a) * t.mPosX * .01,
                    f = (1 - i) * t.mPosY * .01,
                    c = u * e,
                    l = f * e + .75 * t.mSize * .01 * e;
